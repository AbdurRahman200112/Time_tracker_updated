...
export function EditProfile({ admin, onClose, onSave }) {
  ...
  const handleSave = () => {
    axios
      .put(`/api/admins/${admin.id}`, formData)
      .then((response) => {
  ...
  return (
    <div className="edit-profile-container rounded-lg p-6 w-full">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/4 animate-fadeInLeft">
          <div className="p-4 rounded-lg mb-4 shadow-md bg-white w-full pb-20">
            ...
            <div className="flex flex-col items-center">
              ...
              <p
                ...
                className="text-center font-semibold text-lg mt-2"
              >
            ...
            {[
              ...
              >
                ...
                <input
                  ...
                  className="mt-1 w-full border border-gray-300 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100"
                  style={{
