...
export function Notifications() {
  ...
  return (
    <div className="w-full p-6 bg-white rounded-lg shadow-md text-gray-800 mt-10">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mt-4 p-4 mb-6 rounded-md animate-fadeInLeft">
        {/* Profile Section */}
        ...
        <div className="p-3 bg-white shadow-lg flex flex-col md:flex-row md:items-center justify-between px-4">
          <div className="space-y-2 p-5 rounded-lg">
            ...
            <p
              style={{ fontFamily: "Poppins", fontSize: "16px" }}
              className="text-sm text-black-200 rounded-sm"
            >
              Update to the latest version.
            </p>
          </div>
          <button className="text-orange-500 text-2xl mt-2 md:mt-0">
