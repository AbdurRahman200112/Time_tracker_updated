...
export function SignIn() {
  ...
  const handleOtpPaste = (e) => {
    ...
    if (pastedData.length === otp.length) {
      ...
      // Automatically focus on each input after pasting
      ...
      >
        <div className="w-full max-w-md flex items-center justify-center flex-col">
          <Typography
            ...
            style={{ fontFamily: "Poppins", fontWeight: "10px" }}
          >
            Account Log In
          </Typography>
          <Typography
            variant="paragraph"
            style={{ color: "#FC8C10", fontFamily: "Poppins" }}
            className="text-center text-lg mb-6"
          >
            {isCodeSent
              ? `Enter the 6 digit code sent to you at ******${email.slice(
                  -3
                )}@gmail.com`
          ...
          <form
            ...
            onPaste={isCodeSent ? handleOtpPaste : undefined}
          >
            {!isCodeSent ? (
              <>
                <div>
